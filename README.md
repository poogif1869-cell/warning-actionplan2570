...
| `app/(app)/` | 6 หน้า 2 หมวด — ดูข้อมูล: ภาพรวม / แจ้งเตือน (มีแดชบอร์ดความเสี่ยง) / ความเชื่อมโยงแผน · รายงานผล: งบประมาณ / โครงการ-กิจกรรม / ยุทธศาสตร์&ตัวชี้วัด 

> **ทุกครั้งที่ดึงโค้ดใหม่ ให้รัน `supabase/schema.sql` ทั้งไฟล์อีกรอบ**
> รอบล่าสุดเพิ่ม **ตาราง `profiles`** (บทบาทผู้ใช้ viewer/editor/admin) และ
> คอลัมน์ `budget_entries.other` (หมวดค่าใช้จ่ายอื่น ๆ)
